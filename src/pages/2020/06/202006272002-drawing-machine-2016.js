...
const loop = ({ ticks, time, context, pallete, rng, canvas, params }) => {
  ...
  circle({ ...drawPoint.obj, radius: 21, fill: '#444' });
};
...
export default () => (
  <Sketch
    ...
    params={{
      ...
      speed: 1000 / 50, // denominator is number of steps per second
      ...
      leftSpeed: ((Math.PI * 2) / 60 / 1000) * (1 / 2), //bracketted number is inverse of seconds per full rotation,
      leftOffset: 1 / 25,
      leftInitial: 0,
      ...
      stageSpeed: 0, //(((Math.PI * 2) / 60 / 1000) * 1) / 2, //bracketted number is inverse of seconds per full rotation,
      stageOffset: 0,
      stageInitial: 0,
